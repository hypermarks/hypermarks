...
function hypermarks() {
  ...
  function injectDivIntoDomWithClass(classes){
  ...
  overlay = function () {
    injectStyle(overlayCss);
    var div = injectDivIntoDomWithClass(overlayClasses);
